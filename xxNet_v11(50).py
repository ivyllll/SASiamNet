...
class BaseNet(nn.Module):
    def __init__(self, input_nc, output_nc):
        ...
        self.RFEM5 = RFEM(2048, self.mid_d) # res50用的bottleneck的expansion是4，即输出通道是输入通道的四倍
        self.RFEM4 = RFEM(1024, self.mid_d)
        self.RFEM3 = RFEM(512, self.mid_d)
        self.RFEM2 = RFEM(256, self.mid_d)

        self.DM5 = DifferentiationModule(2048, self.mid_d)
        self.DM4 = DifferentiationModule(1024, self.mid_d)
        self.DM3 = DifferentiationModule(512, self.mid_d)
        self.DM2 = DifferentiationModule(256, self.mid_d)
        self.AM5 = AssimilationModule(2048, self.mid_d)
        self.AM4 = AssimilationModule(1024, self.mid_d)
        self.AM3 = AssimilationModule(512, self.mid_d)
        self.AM2 = AssimilationModule(256, self.mid_d)
...
if __name__ == "__main__":
    ...
    net1 = BaseNet(6, 2)
    x1 = net1(x, y) # torch.Size([1, 2, 512, 512])
    print(x1.shape)
