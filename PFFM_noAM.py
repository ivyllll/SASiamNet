...
class BaseNet(nn.Module):
    def __init__(self, input_nc, output_nc):
        ...
        self.conv5 = nn.Conv2d(512, self.mid_d, kernel_size=3, stride=1, padding=1)
        self.conv4 = nn.Conv2d(256, self.mid_d, kernel_size=3, stride=1, padding=1)
        self.conv3 = nn.Conv2d(128, self.mid_d, kernel_size=3, stride=1, padding=1)
        self.conv2 = nn.Conv2d(64, self.mid_d, kernel_size=3, stride=1, padding=1)
    ...
    def forward(self, x1, x2):
        ...
        # dm5 = torch.add(x1_5, x2_5)  # [512, 16, 16]
        # dm4 = torch.add(x1_4, x2_4)  # [256, 32, 32]
        # dm3 = torch.add(x1_3, x2_3)  # [128, 64, 64]
        # dm2 = torch.add(x1_2, x2_2)  # [64, 128, 128]
        # dm5 = self.conv5(torch.add(x1_5, x2_5))
        # dm4 = self.conv4(torch.add(x1_4, x2_4))
        # dm3 = self.conv3(torch.add(x1_3, x2_3))
        # dm2 = self.conv2(torch.add(x1_2, x2_2))

        # am5 = self.AM5(x1_5, x2_5)  # [64, 16, 16]
        # am4 = self.AM4(x1_4, x2_4)  # [64, 32, 32]
        # am3 = self.AM3(x1_3, x2_3)  # [64, 64, 64]
        # am2 = self.AM2(x1_2, x2_2)  # [64, 128, 128]
        am5 = self.conv5(torch.add(x1_5, x2_5))
        am4 = self.conv4(torch.add(x1_4, x2_4))
        am3 = self.conv3(torch.add(x1_3, x2_3))
        am2 = self.conv2(torch.add(x1_2, x2_2))

        # feature difference
        d5 = self.RFEM5(x1_5, x2_5)  # 1/32  [64, 16, 16]
        d4 = self.RFEM4(x1_4, x2_4)  # 1/16  [64, 32, 32]
        d3 = self.RFEM3(x1_3, x2_3)  # 1/8   [64, 64, 64]
        d2 = self.RFEM2(x1_2, x2_2)  # 1/4   [64, 128, 128]
